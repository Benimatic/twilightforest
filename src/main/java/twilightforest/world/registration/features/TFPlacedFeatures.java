...
public class TFPlacedFeatures {
	...
	public static final Holder<PlacedFeature> PLACED_DENSE_TREE = register("tree/dense_tree", TFConfiguredFeatures.DENSE_OAK_TREE, tfTreeCheckArea(PlacementUtils.countExtra(7, 0.1F, 1), TFBlocks.TWILIGHT_OAK_SAPLING.get().defaultBlockState()));
	...
	public static final Holder<PlacedFeature> PLACED_SAVANNAH_DENSE_TREE = register("tree/savannah_dense_tree", TFConfiguredFeatures.DENSE_OAK_TREE, tfTreeCheckArea(PlacementUtils.countExtra(0, 0.1F, 1), TFBlocks.TWILIGHT_OAK_SAPLING.get().defaultBlockState()));
