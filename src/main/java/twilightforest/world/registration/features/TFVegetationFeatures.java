...
public final class TFVegetationFeatures {
	...
	public static final Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> LAKE_LAVA = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("lava_lake"), Feature.LAKE, new LakeFeature.Configuration(BlockStateProvider.simple(BlockConstants.LAVA), BlockStateProvider.simple(Blocks.STONE)));
	public static final Holder<ConfiguredFeature<LakeFeature.Configuration, ?>> LAKE_WATER = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("water_lake"), Feature.LAKE, new LakeFeature.Configuration(BlockStateProvider.simple(BlockConstants.WATER), BlockStateProvider.simple(Blocks.STONE)));

	//"structures" that arent actually structures
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> SIMPLE_WELL = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("simple_well"), TFBiomeFeatures.SIMPLE_WELL.get(), FeatureConfiguration.NONE);
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> FANCY_WELL = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("fancy_well"), TFBiomeFeatures.FANCY_WELL.get(), FeatureConfiguration.NONE);
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> DRUID_HUT = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("druid_hut"), TFBiomeFeatures.DRUID_HUT.get(), FeatureConfiguration.NONE);
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> GRAVEYARD = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("graveyard"), TFBiomeFeatures.GRAVEYARD.get(), FeatureConfiguration.NONE);

	//all the fun little things you find around the dimension
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> BIG_MUSHGLOOM = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("big_mushgloom"), TFBiomeFeatures.BIG_MUSHGLOOM.get(), FeatureConfiguration.NONE);
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> FALLEN_LEAVES = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("fallen_leaves"), TFBiomeFeatures.FALLEN_LEAVES.get(), FeatureConfiguration.NONE);
	public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> FIDDLEHEAD = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("fiddlehead"), Feature.RANDOM_PATCH, FeatureUtils.simplePatchConfiguration(Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(BlockConstants.FIDDLEHEAD))));
	...
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> FOUNDATION = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("foundation"), TFBiomeFeatures.FOUNDATION.get(), FeatureConfiguration.NONE);
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> GROVE_RUINS = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("grove_ruins"), TFBiomeFeatures.GROVE_RUINS.get(), FeatureConfiguration.NONE);
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> HOLLOW_LOG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("hollow_log"), TFBiomeFeatures.FALLEN_HOLLOW_LOG.get(), FeatureConfiguration.NONE);
	...
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> HUGE_LILY_PAD = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("huge_lily_pad"), TFBiomeFeatures.HUGE_LILY_PAD.get(), FeatureConfiguration.NONE);
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> HUGE_WATER_LILY = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("huge_water_lily"), TFBiomeFeatures.HUGE_WATER_LILY.get(), FeatureConfiguration.NONE);
	...
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> MONOLITH = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("monolith"), TFBiomeFeatures.MONOLITH.get(), FeatureConfiguration.NONE);
	...
	public static final Holder<ConfiguredFeature<DiskConfiguration, ?>> MYCELIUM_BLOB = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("mycelium_blob"), TFBiomeFeatures.MYCELIUM_BLOB.get(), new DiskConfiguration(BlockConstants.MYCELIUM, UniformInt.of(4, 6), 3, ImmutableList.of(BlockConstants.GRASS_BLOCK)));
	public static final Holder<ConfiguredFeature<SpikeConfig, ?>> OUTSIDE_STALAGMITE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("outside_stalagmite"), TFBiomeFeatures.CAVE_STALACTITE.get(), new SpikeConfig(BlockStateProvider.simple(Blocks.STONE), UniformInt.of(5, 10), ConstantInt.of(0), false));
	...
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> STONE_CIRCLE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("stone_circle"), TFBiomeFeatures.STONE_CIRCLE.get(), FeatureConfiguration.NONE);
	...
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> WEBS = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("webs"), TFBiomeFeatures.WEBS.get(), FeatureConfiguration.NONE);
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> WOOD_ROOTS_SPREAD = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("ore/wood_roots_spread"), TFBiomeFeatures.WOOD_ROOTS.get(), FeatureConfiguration.NONE);
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> SNOW_UNDER_TREES = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("snow_under_trees"), TFBiomeFeatures.SNOW_UNDER_TREES.get(), FeatureConfiguration.NONE);
	...
	//smol stone veins
	public static final Holder<ConfiguredFeature<OreConfiguration,?>> SMALL_GRANITE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("small_granite"), Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, Blocks.GRANITE.defaultBlockState(), 16));
	public static final Holder<ConfiguredFeature<OreConfiguration,?>> SMALL_DIORITE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("small_diorite"), Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, Blocks.DIORITE.defaultBlockState(), 16));
	public static final Holder<ConfiguredFeature<OreConfiguration,?>> SMALL_ANDESITE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("small_andesite"), Feature.ORE, new OreConfiguration(OreFeatures.NATURAL_STONE, Blocks.ANDESITE.defaultBlockState(), 16));
	...
	public static final Holder<ConfiguredFeature<DiskConfiguration, ?>> UBEROUS_SOIL_PATCH_BIG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("uberous_soil_patch_big"), TFBiomeFeatures.MYCELIUM_BLOB.get(), new DiskConfiguration(BlockConstants.UBEROUS_SOIL, UniformInt.of(4, 8), 1, ImmutableList.of(BlockConstants.PODZOL, BlockConstants.COARSE_DIRT, BlockConstants.DIRT)));
	public static final Holder<ConfiguredFeature<DiskConfiguration, ?>> TROLL_CAVE_MYCELIUM =  TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("troll_cave_mycelium"), TFBiomeFeatures.MYCELIUM_BLOB.get(), new DiskConfiguration(BlockConstants.MYCELIUM, UniformInt.of(3, 5), 0, ImmutableList.of(BlockConstants.STONE, BlockConstants.DEADROCK)));
	public static final Holder<ConfiguredFeature<DiskConfiguration, ?>> TROLL_CAVE_DIRT = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("troll_cave_dirt"), TFBiomeFeatures.MYCELIUM_BLOB.get(), new DiskConfiguration(BlockConstants.DIRT, UniformInt.of(2, 5), 0, ImmutableList.of(BlockConstants.STONE, BlockConstants.DEADROCK)));
	public static final Holder<ConfiguredFeature<DiskConfiguration, ?>> UBEROUS_SOIL_PATCH_SMALL = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("uberous_soil_patch_small"), TFBiomeFeatures.MYCELIUM_BLOB.get(), new DiskConfiguration(BlockConstants.UBEROUS_SOIL, UniformInt.of(2, 3), 0, ImmutableList.of(BlockConstants.PODZOL, BlockConstants.COARSE_DIRT, BlockConstants.DIRT)));
	...
	public static final Holder<ConfiguredFeature<RandomFeatureConfiguration, ?>> WELL_PLACER = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("well_placer"), Feature.RANDOM_SELECTOR, new RandomFeatureConfiguration(ImmutableList.of(new WeightedPlacedFeature(PLACED_FANCY_WELL, 0.07F)), PLACED_SIMPLE_WELL));
	...
	public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> GRASS_PLACER = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("grass_placer"), Feature.RANDOM_PATCH, OTHER_GRASS);
	public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> FOREST_GRASS_PLACER = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("forest_grass_placer"), Feature.RANDOM_PATCH, FOREST_GRASS);
	public static final Holder<ConfiguredFeature<RandomPatchConfiguration, ?>> FLOWER_PLACER = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("flower_placer"), Feature.FLOWER, SMALL_FLOWER_CONFIG);
