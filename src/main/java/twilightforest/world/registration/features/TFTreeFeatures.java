...
public class TFTreeFeatures {
	...
	//base configs
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> TWILIGHT_OAK_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/twilight_oak_tree"), Feature.TREE, TreeConfigurations.TWILIGHT_OAK);
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> SWAMPY_OAK_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/swampy_oak_tree"), Feature.TREE, TreeConfigurations.SWAMPY_OAK);
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> CANOPY_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/canopy_tree"), Feature.TREE, TreeConfigurations.CANOPY_TREE);
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> FIREFLY_CANOPY_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/firefly_canopy_tree"), Feature.TREE, TreeConfigurations.CANOPY_TREE_FIREFLY);
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> DEAD_CANOPY_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/dead_canopy_tree"), Feature.TREE, TreeConfigurations.CANOPY_TREE_DEAD);
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> MANGROVE_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/mangrove_tree"), Feature.TREE, TreeConfigurations.MANGROVE_TREE);
	...
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> TRANSFORMATION_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/transformation_tree"), Feature.TREE, TreeConfigurations.TRANSFORM_TREE);
	...
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> SORTING_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/sorting_tree"), Feature.TREE, TreeConfigurations.SORT_TREE);
	//public static final Holder<ConfiguredFeature<TFTreeFeatureConfig, ?>>> DENSE_OAK_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/dense_oak_tree"), TFBiomeFeatures.CANOPY_OAK.get(), TreeConfigurations.DENSE_OAK);
	...
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> RAINBOW_OAK_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/rainbow_oak"), Feature.TREE, TreeConfigurations.RAINBOAK_TREE);
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> LARGE_RAINBOW_OAK_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/large_rainbow_oak"), Feature.TREE, TreeConfigurations.LARGE_RAINBOAK_TREE);
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> BROWN_CANOPY_MUSHROOM_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("mushroom/brown_canopy_mushroom"), Feature.TREE, TreeConfigurations.MUSHROOM_BROWN);
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> RED_CANOPY_MUSHROOM_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("mushroom/red_canopy_mushroom"), Feature.TREE, TreeConfigurations.MUSHROOM_RED);
	...
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> SNOWY_SPRUCE_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/snowy_spruce_tree"), TFBiomeFeatures.SNOW_TREE.get(), TreeFeatures.SPRUCE.value().config());
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> DARK_FOREST_OAK_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/dark_forest_oak_tree"), TFBiomeFeatures.DARK_CANOPY_TREE.get(), TreeFeatures.OAK.value().config());
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> DARK_FOREST_BIRCH_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/dark_forest_birch_tree"), TFBiomeFeatures.DARK_CANOPY_TREE.get(), TreeFeatures.BIRCH.value().config());
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> VANILLA_OAK_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/vanilla_oak_tree"), Feature.TREE, TreeFeatures.OAK.value().config());
	public static final Holder<ConfiguredFeature<TreeConfiguration, ?>> VANILLA_BIRCH_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/vanilla_birch_tree"), Feature.TREE, TreeFeatures.BIRCH.value().config());
	...
	public static final Holder<ConfiguredFeature<NoneFeatureConfiguration, ?>> DUMMY_TREE = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("tree/dummy"), Feature.NO_OP, NoneFeatureConfiguration.INSTANCE);
