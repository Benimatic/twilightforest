...
public final class ConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> OAK_FALLEN_LOG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("oak_fallen_log"), TFBiomeFeatures.FALLEN_SMALL_LOG.get().configured(new HollowLogConfig(BlockConstants.OAK_LOG, Blocks.AIR.defaultBlockState())).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_OCEAN_FLOOR).rarity(40).squared());
    public static final ConfiguredFeature<?, ?> SPRUCE_FALLEN_LOG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("spruce_fallen_log"), TFBiomeFeatures.FALLEN_SMALL_LOG.get().configured(new HollowLogConfig(BlockConstants.SPRUCE_LOG, Blocks.AIR.defaultBlockState())).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_OCEAN_FLOOR).rarity(40).squared());
    public static final ConfiguredFeature<?, ?> BIRCH_FALLEN_LOG = TwilightFeatures.registerWorldFeature(TwilightForestMod.prefix("birch_fallen_log"), TFBiomeFeatures.FALLEN_SMALL_LOG.get().configured(new HollowLogConfig(BlockConstants.BIRCH_LOG, Blocks.AIR.defaultBlockState())).decorated(TwilightFeatures.OCCUPIES_SURFACE_CLEARANCE).decorated(Features.Decorators.HEIGHTMAP_OCEAN_FLOOR).rarity(40).squared());
