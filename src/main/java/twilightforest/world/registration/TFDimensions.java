...
import twilightforest.world.components.biomesources.TwilightBiomeSource;
...
public class TFDimensions {
	...
	public static void init() {
		Registry.register(Registry.BIOME_SOURCE, TwilightForestMod.prefix("twilight_biomes"), TwilightBiomeSource.CODEC);
