...
public final class BranchesConfiguration {
    public static final Codec<BranchesConfiguration> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    Codec.intRange(1, 16).fieldOf("count_minimum").forGetter(o -> o.branchCount),
                    ...
                    Codec.doubleRange(0, 0.5).fieldOf("spacing_yaw").orElse(0.3d).forGetter(o -> o.branchRadians),
                    // Tilt - Float between 0 and 1 where 0 is straight up, 0.5 is straight out and 1 is straight down.
                    Codec.doubleRange(0, 1).fieldOf("downwards_pitch").orElse(0.2d).forGetter(o -> o.branchPitch)
            ).apply(instance, BranchesConfiguration::new)
    );
    ...
    public final double branchRadians;
    public final double branchPitch;

    public BranchesConfiguration(int branchCount, int randomAddBranches, double length, double randomAddLength, double branchRadians, double branchPitch) {
        this.branchCount = branchCount;
        this.randomAddBranches = randomAddBranches;
        this.length = length;
        this.randomAddLength = randomAddLength;
        this.branchRadians = branchRadians;
        this.branchPitch = branchPitch;
    }

    public BranchesConfiguration(int branchCount, double length) {
        this.branchCount = branchCount;
        this.randomAddBranches = 0;
        this.length = length;
        this.randomAddLength = 0d;
        this.branchRadians = 0.3d;
        this.branchPitch = 0.2d;
    }
