...
public class TFItems {
    ...
    public static void registerItems()
    {
    	...
    	plateNaga = new ItemTFNagaArmor(ARMOR_NAGA, nagaScaleRenderID, EntityEquipmentSlot.CHEST).setUnlocalizedName("plateNaga").setMaxStackSize(1);
    	legsNaga = new ItemTFNagaArmor(ARMOR_NAGA, nagaScaleRenderID, EntityEquipmentSlot.LEGS).setUnlocalizedName("legsNaga").setMaxStackSize(1);
    	...
    	ironwoodHelm = new ItemTFIronwoodArmor(ARMOR_IRONWOOD, ironwoodRenderID, EntityEquipmentSlot.HEAD).setUnlocalizedName("ironwoodHelm").setMaxStackSize(1);
    	ironwoodPlate = new ItemTFIronwoodArmor(ARMOR_IRONWOOD, ironwoodRenderID, EntityEquipmentSlot.CHEST).setUnlocalizedName("ironwoodPlate").setMaxStackSize(1);
    	ironwoodLegs = new ItemTFIronwoodArmor(ARMOR_IRONWOOD, ironwoodRenderID, EntityEquipmentSlot.LEGS).setUnlocalizedName("ironwoodLegs").setMaxStackSize(1);
    	ironwoodBoots = new ItemTFIronwoodArmor(ARMOR_IRONWOOD, ironwoodRenderID, EntityEquipmentSlot.FEET).setUnlocalizedName("ironwoodBoots").setMaxStackSize(1);
    	...
    	fieryHelm = new ItemTFFieryArmor(ARMOR_FIERY, fieryRenderID, EntityEquipmentSlot.HEAD).setUnlocalizedName("fieryHelm").setMaxStackSize(1);
    	fieryPlate = new ItemTFFieryArmor(ARMOR_FIERY, fieryRenderID, EntityEquipmentSlot.CHEST).setUnlocalizedName("fieryPlate").setMaxStackSize(1);
    	fieryLegs = new ItemTFFieryArmor(ARMOR_FIERY, fieryRenderID, EntityEquipmentSlot.LEGS).setUnlocalizedName("fieryLegs").setMaxStackSize(1);
    	fieryBoots = new ItemTFFieryArmor(ARMOR_FIERY, fieryRenderID, EntityEquipmentSlot.FEET).setUnlocalizedName("fieryBoots").setMaxStackSize(1);
    	...
    	steeleafHelm = new ItemTFSteeleafArmor(ARMOR_IRONWOOD, steeleafRenderID, EntityEquipmentSlot.HEAD).setUnlocalizedName("steeleafHelm").setMaxStackSize(1);
    	steeleafPlate = new ItemTFSteeleafArmor(ARMOR_IRONWOOD, steeleafRenderID, EntityEquipmentSlot.CHEST).setUnlocalizedName("steeleafPlate").setMaxStackSize(1);
    	steeleafLegs = new ItemTFSteeleafArmor(ARMOR_IRONWOOD, steeleafRenderID, EntityEquipmentSlot.LEGS).setUnlocalizedName("steeleafLegs").setMaxStackSize(1);
    	steeleafBoots = new ItemTFSteeleafArmor(ARMOR_IRONWOOD, steeleafRenderID, EntityEquipmentSlot.FEET).setUnlocalizedName("steeleafBoots").setMaxStackSize(1);
    	...
    	knightlyHelm = new ItemTFKnightlyArmor(ARMOR_KNIGHTLY, knightlyRenderID, EntityEquipmentSlot.HEAD).setUnlocalizedName("knightlyHelm").setMaxStackSize(1);
    	knightlyPlate = new ItemTFKnightlyArmor(ARMOR_KNIGHTLY, knightlyRenderID, EntityEquipmentSlot.CHEST).setUnlocalizedName("knightlyPlate").setMaxStackSize(1);
    	knightlyLegs = new ItemTFKnightlyArmor(ARMOR_KNIGHTLY, knightlyRenderID, EntityEquipmentSlot.LEGS).setUnlocalizedName("knightlyLegs").setMaxStackSize(1);
    	knightlyBoots = new ItemTFKnightlyArmor(ARMOR_KNIGHTLY, knightlyRenderID, EntityEquipmentSlot.FEET).setUnlocalizedName("knightlyBoots").setMaxStackSize(1);
    	...
    	phantomHelm = new ItemTFPhantomArmor(ARMOR_PHANTOM, phantomRenderID, EntityEquipmentSlot.HEAD).setUnlocalizedName("phantomHelm").setMaxStackSize(1);
    	phantomPlate = new ItemTFPhantomArmor(ARMOR_PHANTOM, phantomRenderID, EntityEquipmentSlot.CHEST).setUnlocalizedName("phantomPlate").setMaxStackSize(1);
