...
public class TFRecipes {
	...
	public static void registerRecipes(RegistryEvent.Register<IRecipe> evt) {
		...
		evt.getRegistry().register(new TFMapCloningRecipe(TFItems.magicMap, TFItems.emptyMagicMap).setRegistryName(TwilightForestMod.ID, "magic_map_cloning"));
		evt.getRegistry().register(new TFMapCloningRecipe(TFItems.mazeMap, TFItems.emptyMazeMap).setRegistryName(TwilightForestMod.ID, "maze_map_cloning"));
		evt.getRegistry().register(new TFMapCloningRecipe(TFItems.oreMap, TFItems.emptyOreMap).setRegistryName(TwilightForestMod.ID, "ore_map_cloning"));
	}
}
