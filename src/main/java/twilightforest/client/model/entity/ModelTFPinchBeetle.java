...
public class ModelTFPinchBeetle<T extends EntityTFPinchBeetle> extends EntityModel<T> {
	...
	RendererModel eye1;
	RendererModel eye2;
	RendererModel tooth1a;
	RendererModel tooth1b;
	RendererModel tooth1c;
	RendererModel tooth2a;
	RendererModel tooth2b;
	RendererModel tooth2c;

	public ModelTFPinchBeetle() {
		textureWidth = 64;
		textureHeight = 32;

		thorax = new RendererModel(this, 0, 22);
		...
		connector2 = new RendererModel(this, 0, 12);
		connector2.addBox(-3F, -3F, -1F, 6, 6, 1);
		connector2.setRotationPoint(0F, 18F, -4F);

		RearEnd = new RendererModel(this, 28, 14);
