...
public class LichModel extends BipedModel<LichEntity> {
	...
	public LichModel() {
		...
		bipedRightArm.addBox(-2.0F, -2.0F, -2.0F, 2.0F, 12.0F, 2.0F);
		bipedRightArm.setTextureSize(64, 64);
		bipedRightArm.setRotationPoint(-5.0F, -2.0F, 0.0F);

		bipedLeftArm = new ModelRenderer(this, 0, 16);
		bipedLeftArm.mirror = true;
		bipedLeftArm.addBox(-1.0F, -2.0F, -2.0F, 2.0F, 12.0F, 2.0F);
	...
	@Override
	public void setRotationAngles(LichEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
