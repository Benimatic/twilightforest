...
public class ModelTFFireBeetle<T extends EntityTFFireBeetle> extends EntityModel<T> {
	...
	public ModelTFFireBeetle() {
		...
		RearEnd = new RendererModel(this, 22, 9);
