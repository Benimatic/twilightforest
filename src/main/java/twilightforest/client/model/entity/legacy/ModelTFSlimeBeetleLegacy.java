...
public class ModelTFSlimeBeetleLegacy extends SegmentedModel<EntityTFSlimeBeetle> {
	ModelRenderer head;
	...
	public ModelTFSlimeBeetleLegacy() {
		this(false);
	}

	public ModelTFSlimeBeetleLegacy(boolean translucent) {
