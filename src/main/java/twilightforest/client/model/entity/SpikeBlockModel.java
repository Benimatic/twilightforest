...
public class SpikeBlockModel extends SegmentedModel<SpikeBlockEntity> {
	ModelRenderer block;
	ModelRenderer[] spikes = new ModelRenderer[27];

	public SpikeBlockModel() {
	...
	@Override
	public void setRotationAngles(SpikeBlockEntity entity, float v, float v1, float v2, float v3, float v4) {
