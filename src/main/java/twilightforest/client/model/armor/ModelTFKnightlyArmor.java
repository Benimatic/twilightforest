...
public class ModelTFKnightlyArmor extends ModelTFArmor {
	...
	public ModelTFKnightlyArmor(float expand) {
		...
		this.shoulderSpike1.addCuboid(-1.0F, -1.0F, -1.0F, 2, 2, 2, 0.5F);
		...
		this.shoulderSpike2.addCuboid(-1.0F, -1.0F, -1.0F, 2, 2, 2, 0.5F);
		...
		this.shoeSpike1.addCuboid(-1.0F, -1.0F, -1.0F, 2, 2, 2, 0.5F);
		...
		this.shoeSpike2.addCuboid(-1.0F, -1.0F, -1.0F, 2, 2, 2, 0.5F);
