...
public class RenderLayerRegistration {
	public static void init() {
		...
		ItemBlockRenderTypes.setRenderLayer(TFBlocks.HOLLOW_OAK_LOG_HORIZONTAL.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(TFBlocks.HOLLOW_SPRUCE_LOG_HORIZONTAL.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(TFBlocks.HOLLOW_BIRCH_LOG_HORIZONTAL.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(TFBlocks.HOLLOW_JUNGLE_LOG_HORIZONTAL.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(TFBlocks.HOLLOW_ACACIA_LOG_HORIZONTAL.get(), cutout);
		...
		ItemBlockRenderTypes.setRenderLayer(TFBlocks.HOLLOW_OAK_LOG_CLIMBABLE.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(TFBlocks.HOLLOW_SPRUCE_LOG_CLIMBABLE.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(TFBlocks.HOLLOW_BIRCH_LOG_CLIMBABLE.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(TFBlocks.HOLLOW_JUNGLE_LOG_CLIMBABLE.get(), cutout);
		ItemBlockRenderTypes.setRenderLayer(TFBlocks.HOLLOW_ACACIA_LOG_CLIMBABLE.get(), cutout);
