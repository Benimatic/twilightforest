...
@OnlyIn(Dist.CLIENT)
public class IceBeamParticle extends SpriteTexturedParticle {

	float initialParticleScale;

	IceBeamParticle(ClientWorld world, double x, double y, double z, double vx, double vy, double vz, float scale) {
