...
public class RenderTFCicadaShot extends EntityRenderer<EntityTFCicadaShot> {
	...
	public RenderTFCicadaShot(EntityRendererManager manager) {
		super(manager);
		this.shadowSize = 0.25F;
	}

	@Override
	public void render(EntityTFCicadaShot entity, float yaw, float partialTicks, MatrixStack stack, IRenderTypeBuffer buffer, int light) {
		stack.push();
	...
	@Override
	public ResourceLocation getEntityTexture(EntityTFCicadaShot entity) {
		return textureLoc;
	}
}
