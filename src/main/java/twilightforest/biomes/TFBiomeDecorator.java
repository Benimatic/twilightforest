...
public class TFBiomeDecorator {
	...
	public static final BlockState OAK_WOOD = TFBlocks.oak_log.get().getDefaultState(); //TODO: Needs to be Twilight Oak Wood
	...
	public static final BlockState CANOPY_WOOD = TFBlocks.canopy_log.get().getDefaultState(); //TODO: Needs to be Canopy Wood
	...
	public static final BlockState MANGROVE_WOOD = TFBlocks.mangrove_log.get().getDefaultState(); //TODO: Needs to be Mangrove Wood
	...
	public static final BlockState DARKWOOD_WOOD = TFBlocks.dark_log.get().getDefaultState(); //TODO: Needs to be Darkwood Wood
	...
	public static final TFTreeFeatureConfig MANGROVE_TREE = (new TFTreeFeatureConfig.Builder(new SimpleBlockStateProvider(MANGROVE_LOG), new SimpleBlockStateProvider(MANGROVE_WOOD), new SimpleBlockStateProvider(MANGROVE_LEAVES), new SimpleBlockStateProvider(ROOTS)).checksWater(true).setSapling(TFBlocks.mangrove_sapling.get())).build();
