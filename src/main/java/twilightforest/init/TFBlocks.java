...
@SuppressWarnings({"WeakerAccess", "unchecked", "unused", "deprecation"})
@Nonnull
...
public class TFBlocks {
	...
	public static final RegistryObject<Block> FIREFLY_JAR = register("firefly_jar", () -> new JarBlock(BlockBehaviour.Properties.of().lightLevel((state) -> 15).noOcclusion().sound(SoundType.BONE_BLOCK).strength(0.3F, 3.0F)));
	public static final RegistryObject<Block> FIREFLY_SPAWNER = register("firefly_particle_spawner", () -> new FireflySpawnerBlock(BlockBehaviour.Properties.of().lightLevel((state) -> 15).noOcclusion().sound(SoundType.BONE_BLOCK).strength(0.3F, 3.0F)));
	public static final RegistryObject<Block> CICADA_JAR = register("cicada_jar", () -> new JarBlock(BlockBehaviour.Properties.of().noOcclusion().randomTicks().sound(SoundType.BONE_BLOCK).strength(0.3F, 3.0F)));
	public static final RegistryObject<Block> MOSS_PATCH = register("moss_patch", () -> new MossPatchBlock(BlockBehaviour.Properties.of().instabreak().mapColor(MapColor.PLANT).noCollission().noOcclusion().pushReaction(PushReaction.DESTROY).sound(SoundType.MOSS)));
	...
	public static final RegistryObject<Block> MUSHGLOOM = register("mushgloom", () -> new MushgloomBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).pushReaction(PushReaction.DESTROY).instabreak().sound(SoundType.FUNGUS).noCollission().noOcclusion().lightLevel((state) -> 3)));
	public static final RegistryObject<Block> TORCHBERRY_PLANT = register("torchberry_plant", () -> new TorchberryPlantBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).pushReaction(PushReaction.DESTROY).instabreak().sound(SoundType.HANGING_ROOTS).noCollission().noOcclusion().lightLevel((state) -> (state.getValue(TorchberryPlantBlock.HAS_BERRIES) ? 8 : 0))));
	public static final RegistryObject<Block> ROOT_STRAND = register("root_strand", () -> new RootStrandBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).pushReaction(PushReaction.DESTROY).instabreak().sound(SoundType.HANGING_ROOTS).noCollission().noOcclusion()));
	public static final RegistryObject<Block> FALLEN_LEAVES = BLOCKS.register("fallen_leaves", () -> new FallenLeavesBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).replaceable().ignitedByLava().pushReaction(PushReaction.DESTROY).instabreak().sound(SoundType.AZALEA_LEAVES).noCollission().noOcclusion()));
	public static final RegistryObject<Block> ROOT_BLOCK = register("root", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).ignitedByLava().strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> LIVEROOT_BLOCK = register("liveroot_block", () -> new LiverootBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).ignitedByLava().strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> UNCRAFTING_TABLE = register("uncrafting_table", () -> new UncraftingTableBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.5F).sound(SoundType.WOOD).ignitedByLava()));
	public static final RegistryObject<Block> SMOKER = register("smoker", () -> new TFSmokerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.GRASS).strength(1.5F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> ENCASED_SMOKER = register("encased_smoker", () -> new EncasedSmokerBlock(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> FIRE_JET = register("fire_jet", () -> new FireJetBlock(BlockBehaviour.Properties.of().mapColor(MapColor.GRASS).strength(1.5F, 6.0F).sound(SoundType.WOOD).randomTicks().lightLevel((state) -> state.getValue(FireJetBlock.STATE) != FireJetVariant.FLAME ? 0 : 15)));
	public static final RegistryObject<Block> ENCASED_FIRE_JET = register("encased_fire_jet", () -> new EncasedFireJetBlock(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.WOOD).lightLevel((state) -> 15)));
	public static final RegistryObject<Block> FIREFLY = BLOCKS.register("firefly", () -> new FireflyBlock(BlockBehaviour.Properties.of().instabreak().lightLevel((state) -> 15).noCollission().pushReaction(PushReaction.DESTROY).sound(SoundType.SLIME_BLOCK)));
	public static final RegistryObject<Block> CICADA = BLOCKS.register("cicada", () -> new CicadaBlock(BlockBehaviour.Properties.of().instabreak().noCollission().pushReaction(PushReaction.DESTROY).sound(SoundType.SLIME_BLOCK)));
	public static final RegistryObject<Block> MOONWORM = BLOCKS.register("moonworm", () -> new MoonwormBlock(BlockBehaviour.Properties.of().instabreak().lightLevel((state) -> 14).noCollission().pushReaction(PushReaction.DESTROY).sound(SoundType.SLIME_BLOCK)));
	...
	public static final RegistryObject<Block> SLIDER = register("slider", () -> new SliderBlock(BlockBehaviour.Properties.of().mapColor(MapColor.DIRT).strength(2.0F, 10.0F).randomTicks().noOcclusion()));
	public static final RegistryObject<Block> IRON_LADDER = register("iron_ladder", () -> new IronLadderBlock(BlockBehaviour.Properties.of().forceSolidOff().requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundType.METAL).noOcclusion().pushReaction(PushReaction.DESTROY)));

	//naga courtyard
	public static final RegistryObject<Block> NAGASTONE_HEAD = register("nagastone_head", () -> new TFHorizontalBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> NAGASTONE = register("nagastone", () -> new NagastoneBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> SPIRAL_BRICKS = register("spiral_bricks", () -> new SpiralBrickBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(1.5F, 10.0F).sound(SoundType.STONE).noOcclusion()));
	public static final RegistryObject<Block> ETCHED_NAGASTONE = register("etched_nagastone", () -> new EtchedNagastoneBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> NAGASTONE_PILLAR = register("nagastone_pillar", () -> new DirectionalRotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(1.5F, 10.0F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> MOSSY_ETCHED_NAGASTONE = register("mossy_etched_nagastone", () -> new EtchedNagastoneBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> MOSSY_NAGASTONE_PILLAR = register("mossy_nagastone_pillar", () -> new DirectionalRotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(1.5F, 10.0F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> CRACKED_ETCHED_NAGASTONE = register("cracked_etched_nagastone", () -> new EtchedNagastoneBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> CRACKED_NAGASTONE_PILLAR = register("cracked_nagastone_pillar", () -> new DirectionalRotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(1.5F, 10.0F).sound(SoundType.STONE)));
	...
	//lich tower
	public static final RegistryObject<RotatedPillarBlock> TWISTED_STONE = register("twisted_stone", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	public static final RegistryObject<Block> TWISTED_STONE_PILLAR = register("twisted_stone_pillar", () -> new WallPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(1.5F, 6.0F).requiresCorrectToolForDrops().noOcclusion(), 12, 16));
	public static final RegistryObject<Block> KEEPSAKE_CASKET = registerBEWLR("keepsake_casket", () -> new KeepsakeCasketBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).pushReaction(PushReaction.BLOCK).noOcclusion().requiresCorrectToolForDrops().strength(50.0F, 1200.0F).sound(SoundType.NETHERITE_BLOCK).lightLevel(state -> state.getValue(BlockLoggingEnum.MULTILOGGED) == BlockLoggingEnum.LAVA ? 15 : 0)));
	public static final RegistryObject<RotatedPillarBlock> BOLD_STONE_PILLAR = register("bold_stone_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(1.5F, 6.0F)));
	public static final RegistryObject<Block> DEATH_TOME_SPAWNER = register("death_tome_spawner", () -> new TomeSpawnerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).ignitedByLava().strength(2.5F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> EMPTY_CANOPY_BOOKSHELF = register("empty_canopy_bookshelf", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).ignitedByLava().strength(1.5F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> CANDELABRA = register("candelabra", () -> new CandelabraBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).lightLevel(state -> state.getValue(AbstractLightableBlock.LIGHTING) == AbstractLightableBlock.Lighting.NORMAL ? 15 : state.getValue(AbstractLightableBlock.LIGHTING) == AbstractLightableBlock.Lighting.OMINOUS ? 7 : 0)));
	...
	public static final RegistryObject<Block> RED_THREAD = register("red_thread", () -> new RedThreadBlock(BlockBehaviour.Properties.of().mapColor(MapColor.FIRE).pushReaction(PushReaction.DESTROY).instabreak().noCollission()));

	//stronghold
	public static final RegistryObject<Block> STRONGHOLD_SHIELD = register("stronghold_shield", () -> new StrongholdShieldBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(-1.0F, 6000000.0F).sound(SoundType.METAL).noLootTable()));
	public static final RegistryObject<Block> TROPHY_PEDESTAL = register("trophy_pedestal", () -> new TrophyPedestalBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(2.0F, 2000.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> UNDERBRICK = register("underbrick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> MOSSY_UNDERBRICK = register("mossy_underbrick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> CRACKED_UNDERBRICK = register("cracked_underbrick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> UNDERBRICK_FLOOR = register("underbrick_floor", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).requiresCorrectToolForDrops().strength(1.5F, 6.0F).sound(SoundType.STONE)));

	//dark tower
	public static final RegistryObject<Block> TOWERWOOD = register("towerwood", () -> new FlammableBlock(1, 0, BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.COLOR_ORANGE).strength(40.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> ENCASED_TOWERWOOD = register("encased_towerwood", () -> new FlammableBlock(1, 0, BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.SAND).strength(40.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> CRACKED_TOWERWOOD = register("cracked_towerwood", () -> new FlammableBlock(1, 0, BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.COLOR_ORANGE).strength(40.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> MOSSY_TOWERWOOD = register("mossy_towerwood", () -> new FlammableBlock(1, 0, BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.COLOR_ORANGE).strength(40.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> INFESTED_TOWERWOOD = register("infested_towerwood", () -> new InfestedTowerwoodBlock(1, 0, BlockBehaviour.Properties.of().ignitedByLava().pushReaction(PushReaction.DESTROY).mapColor(MapColor.COLOR_ORANGE).strength(1.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> REAPPEARING_BLOCK = register("reappearing_block", () -> new ReappearingBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 35.0F).sound(SoundType.WOOD).lightLevel((state) -> 4)));
	// FIXME Split Vanishing block into regular breakable variant, and then the unbreakable variant
	public static final RegistryObject<Block> VANISHING_BLOCK = register("vanishing_block", () -> new VanishingBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).mapColor(MapColor.SAND).strength(-1.0F, 35.0F).sound(SoundType.WOOD).lightLevel((state) -> state.getValue(VanishingBlock.ACTIVE) ? 4 : 0)));
	public static final RegistryObject<Block> LOCKED_VANISHING_BLOCK = register("locked_vanishing_block", () -> new LockedVanishingBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).mapColor(MapColor.SAND).strength(-1.0F, 2000.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> CARMINITE_BUILDER = register("carminite_builder", () -> new BuilderBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 6.0F).sound(SoundType.WOOD).lightLevel((state) -> state.getValue(BuilderBlock.STATE) == TowerDeviceVariant.BUILDER_ACTIVE ? 4 : 0)));
	public static final RegistryObject<Block> BUILT_BLOCK = BLOCKS.register("built_block", () -> new TranslucentBuiltBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).strength(50.0F, 2000.0F).sound(SoundType.METAL).noOcclusion().noLootTable()));
	public static final RegistryObject<Block> ANTIBUILDER = register("antibuilder", () -> new AntibuilderBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 6.0F).sound(SoundType.WOOD).lightLevel((state) -> 10)));
	public static final RegistryObject<Block> ANTIBUILT_BLOCK = BLOCKS.register("antibuilt_block", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).strength(0.3F, 2000.0F).sound(SoundType.METAL).noLootTable().noOcclusion()));
	public static final RegistryObject<GhastTrapBlock> GHAST_TRAP = register("ghast_trap", () -> new GhastTrapBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 6.0F).sound(SoundType.WOOD).lightLevel((state) -> state.getValue(GhastTrapBlock.ACTIVE) ? 15 : 0)));
	public static final RegistryObject<Block> CARMINITE_REACTOR = register("carminite_reactor", () -> new CarminiteReactorBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).mapColor(MapColor.SAND).requiresCorrectToolForDrops().strength(10.0F, 6.0F).sound(SoundType.WOOD).lightLevel((state) -> state.getValue(CarminiteReactorBlock.ACTIVE) ? 15 : 0)));
	public static final RegistryObject<Block> REACTOR_DEBRIS = BLOCKS.register("reactor_debris", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).strength(0.3F, 2000.0F).sound(SoundType.METAL).noLootTable().noOcclusion()));
	public static final RegistryObject<Block> FAKE_GOLD = BLOCKS.register("fake_gold", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).strength(50.0F, 2000.0F).sound(SoundType.METAL).noLootTable()));
	public static final RegistryObject<Block> FAKE_DIAMOND = BLOCKS.register("fake_diamond", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).strength(50.0F, 2000.0F).sound(SoundType.METAL).noLootTable()));
	public static final RegistryObject<Block> EXPERIMENT_115 = BLOCKS.register("experiment_115", () -> new Experiment115Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.DESTROY).strength(0.5F).sound(SoundType.WOOL).randomTicks()));

	//aurora palace
	public static final RegistryObject<Block> AURORA_BLOCK = register("aurora_block", () -> new AuroraBrickBlock(BlockBehaviour.Properties.of().mapColor(MapColor.ICE).strength(10.0F, 6.0F)));
	public static final RegistryObject<RotatedPillarBlock> AURORA_PILLAR = register("aurora_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.ICE).requiresCorrectToolForDrops().strength(2.0F, 6.0F)));
	public static final RegistryObject<Block> AURORA_SLAB = register("aurora_slab", () -> new SlabBlock(BlockBehaviour.Properties.of().mapColor(MapColor.ICE).requiresCorrectToolForDrops().strength(2.0F, 6.0F)));
	public static final RegistryObject<Block> AURORALIZED_GLASS = register("auroralized_glass", () -> new AuroralizedGlassBlock(BlockBehaviour.Properties.copy(Blocks.GLASS).noOcclusion()));

	//highlands/thornlands
	public static final RegistryObject<Block> BROWN_THORNS = register("brown_thorns", () -> new ThornsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PODZOL).pushReaction(PushReaction.BLOCK).strength(50.0F, 2000.0F).sound(SoundType.WOOD).noLootTable()));
	public static final RegistryObject<Block> GREEN_THORNS = register("green_thorns", () -> new ThornsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).pushReaction(PushReaction.BLOCK).strength(50.0F, 2000.0F).sound(SoundType.WOOD).noLootTable()));
	public static final RegistryObject<Block> BURNT_THORNS = register("burnt_thorns", () -> new BurntThornsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).pushReaction(PushReaction.DESTROY).strength(0.01F, 0.0F).sound(SoundType.SAND).noLootTable()));
	public static final RegistryObject<Block> THORN_ROSE = register("thorn_rose", () -> new ThornRoseBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).pushReaction(PushReaction.DESTROY).strength(10.0F, 0.0F).sound(SoundType.GRASS).noCollission()));
	public static final RegistryObject<Block> THORN_LEAVES = register("thorn_leaves", () -> new ThornLeavesBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).ignitedByLava().pushReaction(PushReaction.DESTROY).strength(0.2F).randomTicks().noOcclusion().sound(SoundType.AZALEA_LEAVES).isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> BEANSTALK_LEAVES = register("beanstalk_leaves", () -> new BeanstalkLeavesBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).ignitedByLava().pushReaction(PushReaction.DESTROY).strength(0.2F).randomTicks().noOcclusion().sound(SoundType.AZALEA_LEAVES).isSuffocating((state, getter, pos) -> false).isViewBlocking((state, getter, pos) -> false)));
	public static final RegistryObject<Block> DEADROCK = register("deadrock", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(100.0F, 6000000.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> CRACKED_DEADROCK = register("cracked_deadrock", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(100.0F, 6000000.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> WEATHERED_DEADROCK = register("weathered_deadrock", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(100.0F, 6000000.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> TROLLSTEINN = register("trollsteinn", () -> new TrollsteinnBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).requiresCorrectToolForDrops().strength(2.0F, 6.0F).sound(SoundType.STONE).randomTicks()));
	public static final RegistryObject<Block> WISPY_CLOUD = register("wispy_cloud", () -> new AbstractGlassBlock(BlockBehaviour.Properties.of().mapColor(MapColor.SNOW).replaceable().pushReaction(PushReaction.DESTROY).strength(0.3F, 0.0F).sound(SoundType.WOOL).noOcclusion()) {});
	public static final RegistryObject<Block> FLUFFY_CLOUD = register("fluffy_cloud", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.ICE).pushReaction(PushReaction.DESTROY).strength(0.8F, 0.0F).sound(SoundType.WOOL)));
	...
	public static final RegistryObject<Block> GIANT_LOG = register("giant_log", () -> new GiantBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(128F, 30.0F)));
	public static final RegistryObject<Block> GIANT_LEAVES = register("giant_leaves", () -> new GiantLeavesBlock(BlockBehaviour.Properties.copy(Blocks.OAK_LEAVES).pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.2F * 64.0F, 15.0F).sound(SoundType.AZALEA_LEAVES).noOcclusion()));
	public static final RegistryObject<Block> GIANT_OBSIDIAN = register("giant_obsidian", () -> new GiantBlock(BlockBehaviour.Properties.copy(Blocks.OBSIDIAN).pushReaction(PushReaction.BLOCK).isValidSpawn((state, getter, pos, type) -> false).requiresCorrectToolForDrops().strength(50.0F * 64.0F * 64.0F, 2000.0F * 64.0F * 64.0F)));
	public static final RegistryObject<Block> UBEROUS_SOIL = register("uberous_soil", () -> new UberousSoilBlock(BlockBehaviour.Properties.of().mapColor(MapColor.DIRT).strength(0.6F).sound(SoundType.GRAVEL)));
	public static final RegistryObject<RotatedPillarBlock> HUGE_STALK = register("huge_stalk", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.PLANT).strength(1.5F, 3.0F).sound(SoundType.STEM)));
	public static final RegistryObject<Block> BEANSTALK_GROWER = BLOCKS.register("beanstalk_grower", () -> new GrowingBeanstalkBlock(BlockBehaviour.Properties.of().strength(-1.0F, 6000000.0F).noCollission().noOcclusion().noLootTable()));
	public static final RegistryObject<Block> HUGE_MUSHGLOOM = register("huge_mushgloom", () -> new HugeMushroomBlock(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.COLOR_ORANGE).strength(0.2F).sound(SoundType.WOOD).lightLevel((state) -> 5)));
	public static final RegistryObject<Block> HUGE_MUSHGLOOM_STEM = register("huge_mushgloom_stem", () -> new HugeMushroomBlock(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.COLOR_ORANGE).strength(0.2F).sound(SoundType.WOOD).lightLevel((state) -> 5)));
	public static final RegistryObject<Block> TROLLVIDR = register("trollvidr", () -> new TrollRootBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).pushReaction(PushReaction.DESTROY).sound(SoundType.AZALEA_LEAVES).instabreak().noCollission()));
	public static final RegistryObject<Block> UNRIPE_TROLLBER = register("unripe_trollber", () -> new UnripeTorchClusterBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).pushReaction(PushReaction.DESTROY).sound(SoundType.AZALEA_LEAVES).instabreak().noCollission().randomTicks()));
	public static final RegistryObject<Block> TROLLBER = register("trollber", () -> new TrollRootBlock(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).pushReaction(PushReaction.DESTROY).sound(SoundType.FLOWERING_AZALEA).instabreak().noCollission().lightLevel((state) -> 15)));

	//plateau castle
	public static final RegistryObject<Block> CASTLE_BRICK = register("castle_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> CASTLE_ROOF_TILE = register("castle_roof_tile", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> ENCASED_CASTLE_BRICK_PILLAR = register("encased_castle_brick_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> ENCASED_CASTLE_BRICK_TILE = register("encased_castle_brick_tile", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> BOLD_CASTLE_BRICK_PILLAR = register("bold_castle_brick_pillar", () -> new RotatedPillarBlock(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> BOLD_CASTLE_BRICK_TILE = register("bold_castle_brick_tile", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	...
	public static final RegistryObject<Block> PINK_CASTLE_RUNE_BRICK = register("pink_castle_rune_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> BLUE_CASTLE_RUNE_BRICK = register("blue_castle_rune_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> YELLOW_CASTLE_RUNE_BRICK = register("yellow_castle_rune_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> VIOLET_CASTLE_RUNE_BRICK = register("violet_castle_rune_brick", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.QUARTZ).requiresCorrectToolForDrops().strength(100.0F, 50.0F).sound(SoundType.STONE)));
	public static final RegistryObject<Block> VIOLET_FORCE_FIELD = register("violet_force_field", () -> new ForceFieldBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).strength(-1.0F, 3600000.8F).lightLevel((state) -> 2).noLootTable().noOcclusion()));
	public static final RegistryObject<Block> PINK_FORCE_FIELD = register("pink_force_field", () -> new ForceFieldBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).strength(-1.0F, 3600000.8F).lightLevel((state) -> 2).noLootTable().noOcclusion()));
	public static final RegistryObject<Block> ORANGE_FORCE_FIELD = register("orange_force_field", () -> new ForceFieldBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).strength(-1.0F, 3600000.8F).lightLevel((state) -> 2).noLootTable().noOcclusion()));
	public static final RegistryObject<Block> GREEN_FORCE_FIELD = register("green_force_field", () -> new ForceFieldBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).strength(-1.0F, 3600000.8F).lightLevel((state) -> 2).noLootTable().noOcclusion()));
	public static final RegistryObject<Block> BLUE_FORCE_FIELD = register("blue_force_field", () -> new ForceFieldBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).strength(-1.0F, 3600000.8F).lightLevel((state) -> 2).noLootTable().noOcclusion()));
	...
	public static final RegistryObject<RotatedPillarBlock> CINDER_LOG = register("cinder_log", () -> new TFLogBlock(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.COLOR_GRAY).strength(1.0F)));
	public static final RegistryObject<Block> CINDER_WOOD = register("cinder_wood", () -> new Block(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.COLOR_GRAY).strength(1.0F)));
	public static final RegistryObject<Block> YELLOW_CASTLE_DOOR = register("yellow_castle_door", () -> new CastleDoorBlock(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).mapColor((state) -> state.getValue(CastleDoorBlock.VANISHED) ? MapColor.NONE : MapColor.COLOR_CYAN).requiresCorrectToolForDrops().strength(100.0F, 100.0F)));
	...
	//mini structures
	public static final RegistryObject<Block> TWILIGHT_PORTAL_MINIATURE_STRUCTURE = register("twilight_portal_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
	//	public static final RegistryObject<Block> HEDGE_MAZE_MINIATURE_STRUCTURE = register("hedge_maze_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> HOLLOW_HILL_MINIATURE_STRUCTURE = register("hollow_hill_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> QUEST_GROVE_MINIATURE_STRUCTURE = register("quest_grove_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> MUSHROOM_TOWER_MINIATURE_STRUCTURE = register("mushroom_tower_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
	public static final RegistryObject<Block> NAGA_COURTYARD_MINIATURE_STRUCTURE = register("naga_courtyard_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
	public static final RegistryObject<Block> LICH_TOWER_MINIATURE_STRUCTURE = register("lich_tower_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
	//	public static final RegistryObject<Block> MINOTAUR_LABYRINTH_MINIATURE_STRUCTURE = register("minotaur_labyrinth_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> HYDRA_LAIR_MINIATURE_STRUCTURE = register("hydra_lair_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> GOBLIN_STRONGHOLD_MINIATURE_STRUCTURE = register("goblin_stronghold_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> DARK_TOWER_MINIATURE_STRUCTURE = register("dark_tower_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> YETI_CAVE_MINIATURE_STRUCTURE = register("yeti_cave_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> AURORA_PALACE_MINIATURE_STRUCTURE = register("aurora_palace_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> TROLL_CAVE_COTTAGE_MINIATURE_STRUCTURE = register("troll_cave_cottage_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
//	public static final RegistryObject<Block> FINAL_CASTLE_MINIATURE_STRUCTURE = register("final_castle_miniature_structure", () -> new Block(BlockBehaviour.Properties.of().pushReaction(PushReaction.BLOCK).requiresCorrectToolForDrops().strength(0.75F).noOcclusion()));
	public static final RegistryObject<Block> KNIGHTMETAL_BLOCK = register("knightmetal_block", () -> new KnightmetalBlock(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).requiresCorrectToolForDrops().strength(5.0F, 40.0F).sound(SoundType.NETHERITE_BLOCK)));
	public static final RegistryObject<Block> IRONWOOD_BLOCK = register("ironwood_block", () -> new Block(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.WOOD).strength(5.0F, 6.0F).sound(SoundType.WOOD)));
	public static final RegistryObject<Block> FIERY_BLOCK = registerFireResistantItem("fiery_block", () -> new FieryBlock(BlockBehaviour.Properties.of().mapColor(MapColor.TERRACOTTA_BLACK).requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundType.METAL).noOcclusion().emissiveRendering((state, world, pos) -> true)));
	public static final RegistryObject<Block> STEELEAF_BLOCK = register("steeleaf_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.PLANT).strength(5.0F, 6.0F).sound(SoundType.MOSS)));
	public static final RegistryObject<Block> ARCTIC_FUR_BLOCK = register("arctic_fur_block", () -> new ArcticFurBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOL).ignitedByLava().strength(0.8F).sound(SoundType.WOOL)));
	public static final RegistryObject<Block> CARMINITE_BLOCK = register("carminite_block", () -> new CarminiteBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_RED).instabreak().sound(SoundType.SLIME_BLOCK)));

	//boss trophies and spawners
	public static final RegistryObject<Block> NAGA_BOSS_SPAWNER = register("naga_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.NAGA));
	public static final RegistryObject<Block> LICH_BOSS_SPAWNER = register("lich_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.LICH));
	public static final RegistryObject<Block> HYDRA_BOSS_SPAWNER = register("hydra_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.HYDRA));
	public static final RegistryObject<Block> UR_GHAST_BOSS_SPAWNER = register("ur_ghast_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.UR_GHAST));
	public static final RegistryObject<Block> KNIGHT_PHANTOM_BOSS_SPAWNER = register("knight_phantom_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.KNIGHT_PHANTOM));
	public static final RegistryObject<Block> SNOW_QUEEN_BOSS_SPAWNER = register("snow_queen_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.SNOW_QUEEN));
	public static final RegistryObject<Block> MINOSHROOM_BOSS_SPAWNER = register("minoshroom_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.MINOSHROOM));
	public static final RegistryObject<Block> ALPHA_YETI_BOSS_SPAWNER = register("alpha_yeti_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.ALPHA_YETI));
	public static final RegistryObject<Block> FINAL_BOSS_BOSS_SPAWNER = register("final_boss_boss_spawner", () -> new BossSpawnerBlock(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).strength(-1.0F, 3600000.8F).noOcclusion().noLootTable(), BossVariant.FINAL_BOSS));
	...
	public static final RegistryObject<Block> MANGROVE_ROOT = register("mangrove_root", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE).ignitedByLava().strength(2.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> TWILIGHT_OAK_PLANKS = register("twilight_oak_planks", () -> new Block(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> CANOPY_PLANKS = register("canopy_planks", () -> new Block(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.PODZOL).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> MANGROVE_PLANKS = register("mangrove_planks", () -> new Block(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.DIRT).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> DARK_PLANKS = register("dark_planks", () -> new Block(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.COLOR_ORANGE).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> TIME_PLANKS = register("time_planks", () -> new Block(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.DIRT).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> TRANSFORMATION_PLANKS = register("transformation_planks", () -> new Block(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.WOOD).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> MINING_PLANKS = register("mining_planks", () -> new Block(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.SAND).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<Block> SORTING_PLANKS = register("sorting_planks", () -> new Block(BlockBehaviour.Properties.of().ignitedByLava().mapColor(MapColor.PODZOL).strength(2.0F, 3.0F).sound(SoundType.WOOD)));
	...
	private static BlockBehaviour.Properties logProperties(MapColor color) {
		return BlockBehaviour.Properties.of().ignitedByLava().mapColor(color);
	}

	private static BlockBehaviour.Properties logProperties(MapColor top, MapColor side) {
		return BlockBehaviour.Properties.of().ignitedByLava().mapColor((state) -> state.getValue(RotatedPillarBlock.AXIS) == Direction.Axis.Y ? top : side);
	}
}
