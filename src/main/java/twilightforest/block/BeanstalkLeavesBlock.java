...
public class BeanstalkLeavesBlock extends TFLeavesBlock{
    ...
    private static BlockState updateDistance(BlockState state, LevelAccessor levelAccessor, BlockPos pos) {
        int i = 7;
    ...
    private static int getDistanceAt(BlockState state) {
        return state.is(TFBlocks.HUGE_STALK.get()) ? 0 : state.getBlock() instanceof LeavesBlock ? state.getValue(DISTANCE) : 7;
    }
}
