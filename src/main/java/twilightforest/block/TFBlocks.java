...
public class TFBlocks {
	...
	public static final RegistryObject<Block> torchberry_plant           = BLOCKS.register("torchberry_plant", () -> new BlockTFPlant(PlantVariant.TORCHBERRY, Block.Properties.create(Material.PLANTS).hardnessAndResistance(0.0F).sound(SoundType.PLANT).tickRandomly().doesNotBlockMovement().nonOpaque().lightValue(8)));
	...
	public static void registerItemblocks(RegistryEvent.Register<Item> evt) {
		...
		List<RegistryObject<? extends Block>> standard = Arrays.asList(
						...
						hedge, root, liveroot_block, firefly_jar, iron_ladder, terrorcotta_circle, terrorcotta_diagonal,
