...
//	public static final RegistryObject<Block> final_castle_miniature_structure       = BLOCKS.register("final_castle_miniature_structure", () -> new BlockTFMiniatureStructure());
	...
	public static final RegistryObject<RotatedPillarBlock> stone_twist   = BLOCKS.register("stone_twist", () -> new RotatedPillarBlock(Block.Properties.create(Material.ROCK).hardnessAndResistance(1.5F, 10.0F)));
//	public static final RegistryObject<Block> stone_twist_thin           = BLOCKS.register("stone_twist_thin", () -> new BlockTFWallPillar(Material.ROCK, 12, 16));
	...
	public static final RegistryObject<DoorBlock> twilight_oak_door         = BLOCKS.register("twilight_oak_door", () -> new DoorBlock(Block.Properties.from(twilight_oak_planks.get()).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<DoorBlock> canopy_door               = BLOCKS.register("canopy_door", () -> new DoorBlock(Block.Properties.create(Material.WOOD, MaterialColor.OBSIDIAN).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<DoorBlock> mangrove_door             = BLOCKS.register("mangrove_door", () -> new DoorBlock(Block.Properties.from(mangrove_planks.get()).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<DoorBlock> dark_door                 = BLOCKS.register("dark_door", () -> new DoorBlock(Block.Properties.from(dark_planks.get()).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<DoorBlock> time_door                 = BLOCKS.register("time_door", () -> new DoorBlock(Block.Properties.from(time_planks.get()).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<DoorBlock> trans_door                = BLOCKS.register("trans_door", () -> new DoorBlock(Block.Properties.from(trans_planks.get()).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<DoorBlock> mine_door                 = BLOCKS.register("mine_door", () -> new DoorBlock(Block.Properties.from(mine_planks.get()).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
	...
	public static final RegistryObject<DoorBlock> sort_door                 = BLOCKS.register("sort_door", () -> new DoorBlock(Block.Properties.from(sort_planks.get()).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
