...
public class TFBlocks {
	...
	public static final RegistryObject<Block> cinder_wood                 = BLOCKS.register("cinder_wood", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.COLOR_GRAY)/*.harvestTool(ToolType.AXE)*/.strength(1.0F)));
