...
public class TFBlocks {
	...
	public static final RegistryObject<Block> nagastone_stairs_left            = BLOCKS.register("nagastone_stairs", () -> new BlockTFNagastoneStairs(etched_nagastone.get().getDefaultState()));
	public static final RegistryObject<Block> nagastone_stairs_right           = BLOCKS.register("nagastone_stairs", () -> new BlockTFNagastoneStairs(etched_nagastone.get().getDefaultState()));
	...
	public static final RegistryObject<Block> nagastone_stairs_mossy_left      = BLOCKS.register("nagastone_stairs_mossy", () -> new BlockTFNagastoneStairs(etched_nagastone_mossy.get().getDefaultState()));
	public static final RegistryObject<Block> nagastone_stairs_mossy_right     = BLOCKS.register("nagastone_stairs_mossy", () -> new BlockTFNagastoneStairs(etched_nagastone_mossy.get().getDefaultState()));
	...
	public static final RegistryObject<Block> nagastone_stairs_weathered_left  = BLOCKS.register("nagastone_stairs_weathered", () -> new BlockTFNagastoneStairs(etched_nagastone_weathered.get().getDefaultState()));
	public static final RegistryObject<Block> nagastone_stairs_weathered_right = BLOCKS.register("nagastone_stairs_weathered", () -> new BlockTFNagastoneStairs(etched_nagastone_weathered.get().getDefaultState()));
