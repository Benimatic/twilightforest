...
public class TFBlocks {
	...
	public static final RegistryObject<Block> GIANT_LOG = BLOCKS.register("giant_log", () -> new GiantBlock(BlockBehaviour.Properties.copy(Blocks.OAK_PLANKS).requiresCorrectToolForDrops().strength(128, 0)));
