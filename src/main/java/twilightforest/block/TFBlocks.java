...
//	public static final RegistryObject<Block> final_castle_miniature_structure = BLOCKS.register("final_castle_miniature_structure", () -> new BlockTFMiniatureStructure());
	...
	public static final RegistryObject<Block> canopy_bookshelf              = BLOCKS.register("canopy_bookshelf", () -> new Block(BlockBehaviour.Properties.of(Material.WOOD, MaterialColor.PODZOL).strength(1.5F).sound(SoundType.WOOD)));
