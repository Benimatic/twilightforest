...
public abstract class BossSpawnerTileEntity<T extends Mob> extends BlockEntity {
	...
	protected BossSpawnerTileEntity(BlockEntityType<?> type, EntityType<T> entityType, BlockPos pos, BlockState state) {
