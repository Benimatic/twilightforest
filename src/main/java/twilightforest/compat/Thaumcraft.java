...
public class Thaumcraft {
    ...
    static void init() {
        try {
            ...
            registerTCObjectTag(TFItems.scepterTwilight, -1, (new AspectList()).add(Aspect.MAGIC, 8).add(Aspect.ELDRITCH, 8).add(Aspect.AVERSION, 8));
            registerTCObjectTag(TFItems.scepterLifeDrain, -1, (new AspectList()).add(Aspect.MAGIC, 8).add(Aspect.LIFE, 8).add(Aspect.DESIRE, 8));
            ...
            registerTCObjectTag(TFItems.liveRoot, -1, (new AspectList()).add(Aspect.MAGIC, 1).add(Aspect.PLANT, 2).add(Aspect.LIFE, 2));
            registerTCObjectTag(TFItems.ironwoodIngot, -1, (new AspectList()).add(Aspect.MAGIC, 2).add(Aspect.PLANT, 1).add(Aspect.METAL, 4).add(Aspect.CRAFT, 2));
            ...
            registerTCObjectTag(TFItems.minotaurAxe, -1, (new AspectList()).add(Aspect.TOOL, 2).add(Aspect.AVERSION, 4).add(Aspect.CRYSTAL, 6).add(Aspect.DESIRE, 8));
            registerTCObjectTag(TFItems.mazebreakerPick, -1, (new AspectList()).add(Aspect.CRYSTAL, 6).add(Aspect.TOOL, 8).add(Aspect.TOOL, 8));
            registerTCObjectTag(TFItems.oreMagnet, -1, (new AspectList()).add(Aspect.DESIRE, 10).add(Aspect.TOOL, 6).add(Aspect.METAL, 8).add(Aspect.MOTION, 6));
            ...
            registerTCObjectTag(TFItems.charmOfLife1, -1, (new AspectList()).add(Aspect.LIFE, 2).add(Aspect.LIFE, 2).add(Aspect.DESIRE, 4));
            registerTCObjectTag(TFItems.charmOfKeeping1, -1, (new AspectList()).add(Aspect.DEATH, 1).add(Aspect.MOTION, 2).add(Aspect.DESIRE, 4));
            ...
            registerTCObjectTag(TFItems.borerEssence, -1, (new AspectList()).add(Aspect.BEAST, 2).add(Aspect.PLANT, 2).add(Aspect.SOUL, 4).add(Aspect.MAGIC, 2));
            ...
            registerTCObjectTag(TFItems.phantomHelm, -1, (new AspectList()).add(Aspect.METAL, 6).add(Aspect.PROTECT, 6).add(Aspect.UNDEAD, 6));
            registerTCObjectTag(TFItems.phantomPlate, -1, (new AspectList()).add(Aspect.METAL, 8).add(Aspect.PROTECT, 8).add(Aspect.UNDEAD, 8));
            registerTCObjectTag(TFItems.armorShard, -1, (new AspectList()).add(Aspect.METAL, 1));
            ...
            registerTCObjectTag(TFItems.alphaFur, -1, (new AspectList()).add(Aspect.COLD, 3).add(Aspect.BEAST, 3).add(Aspect.MAGIC, 4).add(Aspect.PROTECT, 1));
            ...
            registerTCObjectTag(TFItems.tripleBow, -1, (new AspectList()).add(Aspect.PLANT, 6).add(Aspect.BEAST, 6).add(Aspect.PROTECT, 6).add(Aspect.AVERSION, 9).add(Aspect.AIR, 3));
            registerTCObjectTag(TFItems.seekerBow, -1, (new AspectList()).add(Aspect.MIND, 3).add(Aspect.BEAST, 2).add(Aspect.PROTECT, 2).add(Aspect.AVERSION, 3).add(Aspect.AIR, 1));
            registerTCObjectTag(TFItems.iceBow, -1, (new AspectList()).add(Aspect.COLD, 2).add(Aspect.BEAST, 2).add(Aspect.PROTECT, 2).add(Aspect.AVERSION, 3).add(Aspect.AIR, 1));
            registerTCObjectTag(TFItems.enderBow, -1, (new AspectList()).add(Aspect.MOTION, 2).add(Aspect.BEAST, 2).add(Aspect.PROTECT, 2).add(Aspect.AVERSION, 3).add(Aspect.AIR, 1));
            registerTCObjectTag(TFItems.iceSword, -1, (new AspectList()).add(Aspect.AVERSION, 4).add(Aspect.CRYSTAL, 4).add(Aspect.COLD, 4));
            registerTCObjectTag(TFItems.glassSword, -1, (new AspectList()).add(Aspect.AVERSION, 5).add(Aspect.CRYSTAL, 4));
            ...
            // food
            registerTCObjectTag(TFItems.venisonRaw, -1, (new AspectList()).add(Aspect.DESIRE, 2).add(Aspect.BEAST, 4).add(Aspect.BEAST, 2));
            registerTCObjectTag(TFItems.venisonCooked, -1, (new AspectList()).add(Aspect.DESIRE, 4).add(Aspect.BEAST, 4).add(Aspect.CRAFT, 1));
            registerTCObjectTag(TFItems.hydraChop, -1, (new AspectList()).add(Aspect.DESIRE, 6).add(Aspect.BEAST, 6).add(Aspect.LIFE, 4));
            registerTCObjectTag(TFItems.meefRaw, -1, (new AspectList()).add(Aspect.BEAST, 2).add(Aspect.BEAST, 4).add(Aspect.LIFE, 2));
            registerTCObjectTag(TFItems.meefSteak, -1, (new AspectList()).add(Aspect.FIRE, 1).add(Aspect.BEAST, 1).add(Aspect.BEAST, 4).add(Aspect.LIFE, 2));
            registerTCObjectTag(TFItems.meefStroganoff, -1, (new AspectList()).add(Aspect.DESIRE, 4).add(Aspect.BEAST, 2).add(Aspect.BEAST, 4));
            registerTCObjectTag(TFItems.mazeWafer, -1, (new AspectList()).add(Aspect.DESIRE, 2));
            registerTCObjectTag(TFItems.experiment115, -1, (new AspectList()).add(Aspect.DESIRE, 3).add(Aspect.MECHANISM, 1));
            ...
            registerTCObjectTag(TFBlocks.mazestone, -1, (new AspectList()).add(Aspect.ORDER, 2).add(Aspect.TRAP, 1).add(Aspect.PROTECT, 1));
            registerTCObjectTag(TFBlocks.hedge, 0, (new AspectList()).add(Aspect.PLANT, 1).add(Aspect.AVERSION, 1));
            registerTCObjectTag(TFBlocks.hedge, 1, (new AspectList()).add(Aspect.PLANT, 3).add(Aspect.DARKNESS, 1));
            registerTCObjectTag(TFBlocks.root, -1, (new AspectList()).add(Aspect.PLANT, 2));
            registerTCObjectTag(TFBlocks.cicada, -1, (new AspectList()).add(Aspect.SENSES, 2));
            registerTCObjectTag(TFBlocks.uncraftingTable, -1, (new AspectList()).add(Aspect.PLANT, 4).add(Aspect.ENTROPY, 8).add(Aspect.EXCHANGE, 12).add(Aspect.CRAFT, 16));
            ...
            registerTCObjectTag(TFBlocks.towerWood, -1, (new AspectList()).add(Aspect.PLANT, 2).add(Aspect.MECHANISM, 2));
            registerTCObjectTag(TFBlocks.towerDevice, -1, (new AspectList()).add(Aspect.PLANT, 4).add(Aspect.MECHANISM, 4).add(Aspect.MAGIC, 4));
            registerTCObjectTag(TFBlocks.towerTranslucent, -1, (new AspectList()).add(Aspect.PLANT, 4).add(Aspect.MECHANISM, 4).add(Aspect.MAGIC, 4).add(Aspect.VOID, 2));
            ...
            registerTCObjectTag(TFBlocks.sapling, -1, (new AspectList()).add(Aspect.PLANT, 4).add(Aspect.PLANT, 2));
            registerTCObjectTag(TFBlocks.moonworm, -1, (new AspectList()).add(Aspect.DARKNESS, 2).add(Aspect.LIGHT, 2));
            registerTCObjectTag(TFBlocks.shield, -1, (new AspectList()).add(Aspect.TRAP, 1).add(Aspect.MAGIC, 1).add(Aspect.PROTECT, 1));
            registerTCObjectTag(TFBlocks.trophyPedestal, -1, (new AspectList()).add(Aspect.DESIRE, 6).add(Aspect.BEAST, 5));
            ...
            registerTCObjectTag(TFBlocks.shield, -1, (new AspectList()).add(Aspect.EARTH, 1).add(Aspect.ORDER, 2).add(Aspect.PROTECT, 2));
            ...
            registerTCObjectTag(TFBlocks.wispyCloud, -1, (new AspectList()).add(Aspect.WATER, 1).add(Aspect.AIR, 1).add(Aspect.FLIGHT, 1));
            registerTCObjectTag(TFBlocks.fluffyCloud, -1, (new AspectList()).add(Aspect.WATER, 2).add(Aspect.AIR, 2));
            registerTCObjectTag(TFBlocks.giantCobble, -1, (new AspectList()).add(Aspect.EARTH, 8).add(Aspect.ENTROPY, 8));
            registerTCObjectTag(TFBlocks.giantLog, -1, (new AspectList()).add(Aspect.PLANT, 32));
            ...
            registerTCObjectTag(TFBlocks.hugeStalk, -1, (new AspectList()).add(Aspect.PLANT, 2).add(Aspect.PLANT, 2));
            ...
            registerTCObjectTag(TFBlocks.forceField, -1, (new AspectList()).add(Aspect.MAGIC, 3).add(Aspect.PROTECT, 4));
