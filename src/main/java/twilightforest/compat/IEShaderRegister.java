...
public class IEShaderRegister {
    ...
    private static final TriConsumer<IntConsumer, Boolean, Float> SPIRAL_TRICONSUMER = (shaderCallback, pre, partialTick) -> {
        if (pre) ShaderHelper.useShader(ShaderHelper.spiralShader, shaderCallback);
        else     ShaderHelper.releaseShader();
    };
    ...
    static {
        ...
        if ((iManager = MINECRAFT.getResourceManager()) instanceof SimpleReloadableResourceManager) ((SimpleReloadableResourceManager) iManager).registerReloadListener(shaderReloadListener = (manager -> SHADERS = ImmutableList.of(
                ...
                registerShaderCasesEngineer( "Pinch Beetle"      , "1_0"   , RARITY, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                           ).setInfo("Twilight Forest", "Pinch Beetle"             , "pinch_beetle"       ),
                registerShaderCasesEngineer( "Questing Ram"      , "1_0"   , RARITY, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                           ).setInfo("Twilight Forest", "Questing Ram"             , "questing_ram"       ),
                ...
                registerShaderCasesEngineer( "Carminite"         , "1_3"   , RARITY, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF,                 (rl, s, c) -> new ShaderConsumerShaderLayer( new ResourceLocation(rl + s), 0xFFFFFFFF, SPIRAL_TRICONSUMER  , ShaderHelper.STAR_UNIFORMS )).setInfo("Twilight Forest", "Carminite"                , "carminite"          ),
                ...
                registerShaderCasesEngineer( "Ironwood"          , "1_0"   , RARITY, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                           ).setInfo("Twilight Forest", "Ironwood"                 , "ironwood"           ),
                registerShaderCasesEngineer( "Steeleaf"          , "1_0"   , RARITY, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                           ).setInfo("Twilight Forest", "Steeleaf"                 , "steeleaf"           ),
                ...
                registerShaderCasesEngineer( "Cube of Annilation", "1_0"   , RARITY, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                           ).setInfo("Twilight Forest", "Cube of Annilation"       , "cube_of_annilation" )
        )));
    }
