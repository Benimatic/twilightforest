...
public class ComponentNagaCourtyardTerraceStatue extends StructureTFComponentTemplate {
    private static final ResourceLocation TERRACE = new ResourceLocation(TwilightForestMod.ID, "courtyard/terrace_statue");
