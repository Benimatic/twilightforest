...
public class ComponentTFMazeDeadEndShrooms extends ComponentTFMazeDeadEndRoots {
	...
	public boolean addComponentParts(World world, Random rand, StructureBoundingBox sbb) {
		...
		this.fillWithBlocks(world, sbb, mushX, 1, 4, mushX, mushY, 4, mushType.with(BlockHugeMushroom.VARIANT, BlockHugeMushroom.EnumType.STEM), AIR, false);
		this.fillWithBlocks(world, sbb, mushX - 1, mushY, 3, mushX + 1, mushY, 4, mushType.with(BlockHugeMushroom.VARIANT, BlockHugeMushroom.EnumType.ALL_OUTSIDE), AIR, false);
