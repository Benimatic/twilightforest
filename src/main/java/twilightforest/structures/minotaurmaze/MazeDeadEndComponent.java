...
public class MazeDeadEndComponent extends TFStructureComponentOld {
	...
	public MazeDeadEndComponent(TemplateManager manager, CompoundNBT nbt) {
		this(MinotaurMazePieces.TFMMDE, nbt);
	}

	public MazeDeadEndComponent(IStructurePieceType piece, CompoundNBT nbt) {
		super(piece, nbt);
	}

	public MazeDeadEndComponent(IStructurePieceType type, TFFeature feature, int i, int x, int y, int z, Direction rotation) {
