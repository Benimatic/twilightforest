...
public class AdherentEntity extends Monster implements RangedAttackMob, ITFCharger {
 	...
 	private static final EntityDataAccessor<Boolean> CHARGE_FLAG = SynchedEntityData.defineId(AdherentEntity.class, EntityDataSerializers.BOOLEAN);

	public AdherentEntity(EntityType<? extends AdherentEntity> type, Level world) {
		super(type, world);
	}
