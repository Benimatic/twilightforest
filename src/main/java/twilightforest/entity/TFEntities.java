...
public class TFEntities {
	...
	public static void registerEntityRenderer(EntityRenderersEvent.RegisterRenderers event) {
		...
		event.registerEntityRenderer(lich_minion, m -> new TFBipedRenderer<>(m, new LichMinionModel(m.bakeLayer(TFModelLayers.LICH_MINION)), new LichMinionModel(m.bakeLayer(TFModelLayers.LICH_MINION_ARMOR)), new LichMinionModel(m.bakeLayer(TFModelLayers.LICH_MINION_ARMOR)), 0.5F, "textures/entity/zombie/zombie.png"));
