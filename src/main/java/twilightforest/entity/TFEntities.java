...
public class TFEntities {
	...
	public static void registerEntityRenderer() {
		...
		RenderingRegistry.registerEntityRenderingHandler(redcap, m -> new TFBipedRenderer<>(m, new RedcapModel<>(0.0F), new HumanoidModel<>(0.7F), new HumanoidModel<>(0.7F), 0.4F, "redcap.png"));
		...
		RenderingRegistry.registerEntityRenderingHandler(redcap_sapper, m -> new TFBipedRenderer<>(m, new RedcapModel<>(0.0F), new HumanoidModel<>(0.75F), new HumanoidModel<>(0.75F), 0.4F, "redcapsapper.png"));
		...
		// projectiles
		RenderingRegistry.registerEntityRenderingHandler(nature_bolt, m -> new ThrownItemRenderer<>(m, Minecraft.getInstance().getItemRenderer()));
		RenderingRegistry.registerEntityRenderingHandler(lich_bolt, m -> new ThrownItemRenderer<>(m, Minecraft.getInstance().getItemRenderer()));
		RenderingRegistry.registerEntityRenderingHandler(wand_bolt, m -> new ThrownItemRenderer<>(m, Minecraft.getInstance().getItemRenderer()));
		RenderingRegistry.registerEntityRenderingHandler(tome_bolt, m -> new ThrownItemRenderer<>(m, Minecraft.getInstance().getItemRenderer()));
		RenderingRegistry.registerEntityRenderingHandler(hydra_mortar, HydraMortarRenderer::new);
		RenderingRegistry.registerEntityRenderingHandler(slime_blob, m -> new ThrownItemRenderer<>(m, Minecraft.getInstance().getItemRenderer()));
		...
		RenderingRegistry.registerEntityRenderingHandler(charm_effect, m -> new ThrownItemRenderer<>(m, Minecraft.getInstance().getItemRenderer()));
		RenderingRegistry.registerEntityRenderingHandler(lich_bomb, m -> new ThrownItemRenderer<>(m, Minecraft.getInstance().getItemRenderer()));
		...
		RenderingRegistry.registerEntityRenderingHandler(ice_snowball, m -> new ThrownItemRenderer<>(m, Minecraft.getInstance().getItemRenderer()));
