...
public class IEShaderRegister {
	...
	public static void initShaders() {
		NONBOSSES = ImmutableList.of(
				...
				registerShaderCases      ( "Twilight"            , ModType.TWILIGHT_FOREST, "1_4"      , RARITY, 0xFF_4C_64_5B, 0xFF_28_25_3F, 0xFF_00_AA_00, 0xFF_FF_FF_FF, (m, t, s, c) -> new ShaderConsumerLayer( m.provideTex(t, s), 0xFFFFFFFF, TWILIGHT_TRICONSUMER , ShaderManager.Uniforms.STAR_UNIFORMS )                                                               ).setInfo("Twilight Forest", "Twilight Forest"          , "twilightforest"     ),
				registerShaderCases      ( "Firefly"             , ModType.TWILIGHT_FOREST, "1_6"      , RARITY, 0xFF_66_41_40, 0xFF_F5_99_2F, 0xFF_C0_FF_00, 0xFF_C0_FF_00, LAYER_PROVIDER, (m, t, s, c) -> new ShaderConsumerLayer( ModType.TWILIGHT_FOREST.provideTex(t, "processed"), 0xFFFFFFFF, FIREFLY_TRICONSUMER  , ShaderManager.Uniforms.TIME_UNIFORM  )                ).setInfo("Twilight Forest", "Firefly"                  , "firefly"            ),
				registerShaderCases      ( "Pinch Beetle"        , ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xFF_BC_93_27, 0xFF_24_16_09, 0xFF_24_16_09, 0xFF_44_44_44, LAYER_PROVIDER, (m, t, s, c) -> new ShaderCase.ShaderLayer( m.provideTex(t, "1_6"), c )                                                                                                  ).setInfo("Twilight Forest", "Pinch Beetle"             , "pinch_beetle"       ),
				...
				registerShaderCasesTopped( "Towerwood"           , ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xFF_A6_65_3A, 0xFF_F5_DA_93, 0xFF_83_5A_35, 0xFF_FF_FF_FF, new ShaderLayerProvider<?>[]{ LAYER_PROVIDER, YELLOW_CIRCUIT_SHADER_PROVIDER }                                                                                                    , TOWER_DEVICE_SHADER_PROVIDER ).setInfo("Twilight Forest", "Towerwood Planks"         , "towerwood"          ),
				...
				registerShaderCases      ( "Auroralized"         , ModType.TWILIGHT_FOREST, "1_5"      , RARITY, 0xFF_00_FF_FF, 0xFF_00_FF_00, 0xFF_00_00_FF, 0xFF_FF_FF_FF, (m, t, s, c) -> new ShaderConsumerLayer( m.provideTex(t, s), 0xFFFFFFFF, AURORA_TRICONSUMER   , ShaderManager.Uniforms.TIME_UNIFORM  )                                                               ).setInfo("Twilight Forest", "Aurora Palace"            , "aurora"             ),

				registerShaderCases      ( "Ironwood"            , ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xFF_6B_61_61, 0xFF_5F_4D_40, 0xFF_5E_57_4B, 0xFF_FF_FF_FF, (m, t, s, c) -> new ShaderCase.ShaderLayer( ModType.TWILIGHT_FOREST.provideTex(t, "streaks"), 0xFF_79_7C_43 ), LAYER_PROVIDER                                                             ).setInfo("Twilight Forest", "Ironwood"                 , "ironwood"           ),
				registerShaderCases      ( "Steeleaf"            , ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xFF_52_87_3A, 0xFF_1E_32_14, 0xFF_41_62_30, 0xFF_FF_FF_FF, (m, t, s, c) -> new ShaderCase.ShaderLayer( ModType.IMMERSIVE_ENGINEERING.provideTex(t, "1_4"), 0xFF_41_62_30 ), (m, t, s, c) -> new ShaderCase.ShaderLayer( ModType.TWILIGHT_FOREST.provideTex(t, "streaks"), 0xFF_6D_A2_5E ), LAYER_PROVIDER ).setInfo("Twilight Forest", "Steeleaf"                 , "steeleaf"           ),
				registerShaderCases      ( "Knightly"            , ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xFF_E7_FC_CD, 0xFF_4D_4C_4B, 0xFF_80_8C_72, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                                                                                   ).setInfo("Twilight Forest", "Knightly"                 , "knightly"           ),
				registerShaderCases      ( "Fiery"               , ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xFF_19_13_13, 0xFF_FD_D4_5D, 0xFF_77_35_11, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                                                                                   ).setInfo("Twilight Forest", "Fiery"                    , "fiery"              ),
				...
				//registerShaderCases      ( "Cube of Annihilation", ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xFF_00_00_03, 0xFF_14_00_40, 0xFF_00_00_03, 0xFF_14_00_40, (m, t, s, c) -> new ShaderConsumerLayer( m.provideTex(t, s), 0xFF_14_00_40, OUTLINE_TRICONSUMER, ShaderHelper.TIME_UNIFORM )                                                             ).setInfo("Twilight Forest", "Cube of Annilation"       , "cube_of_annilation" )
				registerShaderCases      ( "Cube of Annihilation", ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xFF_00_00_03, 0xFF_14_00_40, 0xFF_00_00_03, 0xFF_14_00_40, (m, t, s, c) -> new ShaderCase.ShaderLayer( m.provideTex(t, s), 0xFF_14_00_40 )                                                                                                            ).setInfo("Twilight Forest", "Cube of Annilation"       , "cube_of_annilation" )
		);
		...
		listBuilder.add(
				registerShaderCases      ( "Questing Ram"        , ModType.TWILIGHT_FOREST, "streaks"  , RARITY, 0xFF_F9_E1_C8, 0xFF_9A_85_69, 0xFF_2F_2B_36, 0xFF_90_D8_EF, LAYER_PROVIDER, (m, t, s, c) -> new ShaderConsumerLayer( ModType.IMMERSIVE_ENGINEERING.provideTex(t, "circuit"), 0x30_90_D8_EF, RAM_TRICONSUMER )                                         ).setInfo("Twilight Forest", "Questing Ram"             , "questing_ram"       ),

				registerShaderCases      ( "Naga"                , ModType.TWILIGHT_FOREST, "scales"   , RARITY, 0xFF_32_5D_25, 0xFF_17_29_11, 0xFF_A5_D4_16, 0xFF_FF_FF_FF, LAYER_PROVIDER, (m, t, s, c) -> new ShaderCase.ShaderLayer( ModType.IMMERSIVE_ENGINEERING.provideTex(t, "shark"), 0xFF_FF_FF_FF )                                                         ).setInfo("Twilight Forest", "Naga Boss"                , "naga"               ),
				registerShaderCases      ( "Lich"                , ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xFF_DF_D9_CC, 0xFF_C3_9C_00, 0xFF_3A_04_75, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                                                                                   ).setInfo("Twilight Forest", "Twilight Lich Boss"       , "lich"               ),

				registerShaderCases      ( "Minoshroom"          , ModType.TWILIGHT_FOREST, "1_6"      , RARITY, 0xFF_A8_10_12, 0xFF_B3_B3_B3, 0xFF_33_EB_CB, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                                                                                   ).setInfo("Twilight Forest", "Minoshroom Miniboss"      , "minoshroom"         ),
				registerShaderCases      ( "Hydra"               , ModType.TWILIGHT_FOREST, "scales"   , RARITY, 0xFF_14_29_40, 0xFF_29_80_6B, 0xFF_F1_0A_92, 0xFF_FF_FF_FF, LAYER_PROVIDER, (m, t, s, c) -> new ShaderCase.ShaderLayer( ModType.IMMERSIVE_ENGINEERING.provideTex(t, "shark"), 0xFF_FF_FF_FF )                                                         ).setInfo("Twilight Forest", "Hydra Boss"               , "hydra"              ),

				registerShaderCases      ( "Knight Phantom"      , ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xCC_40_6D_05, 0xFF_36_35_34, 0xFF_7A_5C_49, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                                                                                   ).setInfo("Twilight Forest", "Knight Phantom Minibosses", "knight_phantom"     ),
				registerShaderCases      ( "Ur-Ghast"            , ModType.TWILIGHT_FOREST, "1_2"      , RARITY, 0xFF_F9_F9_F9, 0xFF_9A_37_37, 0xFF_56_56_56, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                                                                                   ).setInfo("Twilight Forest", "Ur-Ghast"                 , "ur-ghast"           ),

				registerShaderCases      ( "Alpha Yeti"          , ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xFF_FC_FC_FC, 0xFF_4A_80_CE, 0xFF_25_3F_66, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                                                                                   ).setInfo("Twilight Forest", "Alpha Yeti"               , "alpha_yeti"         ),
				registerShaderCases      ( "Snow Queen"          , ModType.TWILIGHT_FOREST, "1_0"      , RARITY, 0xFF_DC_FB_FF, 0xFF_C3_9C_00, 0xFF_03_05_89, 0xFF_FF_FF_FF, LAYER_PROVIDER                                                                                                                                                                                                   ).setInfo("Twilight Forest", "Snow Queen"               , "snow_queen"         )
		);
