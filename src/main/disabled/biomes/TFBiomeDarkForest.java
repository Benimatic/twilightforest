...
public class TFBiomeDarkForest extends TFBiomeBase {
	...
	public void addSpawns() {
		...
		addSpawn(EntityClassification.MONSTER, new SpawnListEntry(TFEntities.mist_wolf, 10, 1, 4));
		addSpawn(EntityClassification.MONSTER, new SpawnListEntry(TFEntities.skeleton_druid, 10, 1, 4));
		addSpawn(EntityClassification.MONSTER, new SpawnListEntry(TFEntities.king_spider, 10, 1, 4));
		addSpawn(EntityClassification.MONSTER, new SpawnListEntry(TFEntities.kobold, 10, 4, 8));
